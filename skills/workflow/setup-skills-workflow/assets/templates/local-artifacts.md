...
An initiative is a folder under `.initiatives/` that contains local artifacts for a specific initiative (e.g. MVP, Add Dark Mode, Billing Redesign, etc.).
...
- Use the name and path provided by the user for the artifact, if none is provided, propose a relevant name and path based on the context.
