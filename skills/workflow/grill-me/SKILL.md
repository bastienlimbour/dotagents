...
2. Use available evidence before asking. Inspect codebase, docs, issues, specs, briefs, ADRs, or notes when they can answer.
...
9. Stop only when critical branches are answered, explicitly deferred, or no longer material, and the user agrees understanding is sufficient.
