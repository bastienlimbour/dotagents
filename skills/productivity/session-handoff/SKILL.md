...
If the user passed arguments or provided informations about the next session, treat them as a description of what the next session will focus on and tailor the handoff document accordingly.
